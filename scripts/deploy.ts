...
async function main() {
  ...
  const constructor = myCallData.compile('constructor', {
    counter: 100,
    kill_switch: '0x05f7151ea24624e12dde7e1307f9048073196644aa54d74a9c579a257214b542',
  ...
  console.log(`✅ Contract has been deploy with the address: ${myTestContract.address}`)
}
main()
  .then(() => process.exit(0))
  .catch((error) => {
